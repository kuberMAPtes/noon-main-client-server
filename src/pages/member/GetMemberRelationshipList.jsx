...
} from "./function/GetMemberRelationshipListUtil";
...
const GetMemberRelationshipList = () => {
  ...
  const MemberRelationshipButton = ({
    ...
    return <>{memberRelationshipButtton}</>;
  };
  ...
  return (
    <Container style={{ width: "100%", margin: "0px", maxWidth: "10000px" }}>
      <Row style={{ border: "1px solid #ccc", borderRadius: "8px" }}>
        <Col
          ...
          className={`${module.tab} ${
            activeTab === "follower" ? module.active : ""
          }`}
        >
          팔로워 {followerCount}
        </Col>
        <Col
          ...
          className={`${module.tab} ${
            activeTab === "following" ? module.active : ""
          }`}
        >
          팔로잉 {followingCount}
        </Col>
      ...
      {getActiveList().map(
        (
          memberRelationship,
          index //memberRelationship은 이미 팔로우만 있거나 팔로잉만 있거나 선택되었음.
        ) => (
          <div
            key={
            ...
            ref={
              yourRelationshipLists[activeTab]?.length === index + 1
                ? lastElementRef
                : null
            }
          >
              ...
              >
                ...
                >
                  <Col xs={2} style={{ margin: "0px", padding: "0px" }}>
                    <Image
                      src={
                        memberRelationship?.fromMember?.profilePhotoUrl ||
                        defaultPhotoUrl
                      }
              ...
              >
                <Row className="align-items-center" style={{ width: "100%" }}>
                  <Col xs={2} style={{ margin: "0px", padding: "0px" }}>
                    <Image
                      src={
                        memberRelationship?.toMember?.profilePhotoUrl ||
                        defaultPhotoUrl
                      }
                      className={module.profilePhotoUrl}
                      onClick={() =>
                        handleImageClick(memberRelationship?.toMember?.memberId)
                      }
                      roundedCircle
                    />
                  </Col>
